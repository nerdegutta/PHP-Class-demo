...
class Dbh {
	...
	function __construct() {
		$array = include 'class_test.php';			# Read the array in the class_test file. Placethis file outside the html/php files.
		...
		$this->servername 	= $data[0];				# The servername is at pos 0
